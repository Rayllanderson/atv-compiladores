...
import static com.rayllanderson.compilador.geradores.Token.*;

%% // inicio da seção
 // aqui introduzimos um método para mostrar
 // o lexema == >> classificação do token
%{
 public String imprimir(String token, String lexema) {
...
{operador} { imprimir("OPERADOR ARITMETICO : ", yytext()); return OPERADOR_ARITMÉTICO; }
